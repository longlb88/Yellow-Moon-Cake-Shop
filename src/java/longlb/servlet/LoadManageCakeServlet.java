...
import longlb.tblstatus.TblStatusDAO;
import longlb.tblstatus.TblStatusDTO;
 ...
 * @author Long Le
 */
@WebServlet(name = "LoadManageCakeServlet", urlPatterns = {"/LoadManageCakeServlet"})
public class LoadManageCakeServlet extends HttpServlet {
    private final Logger log = Logger.getLogger(LoadManageCakeServlet.class.getName());
    private final String MANAEGE_CAKE_PAGE = "manage-cake-page";
    /**
	...
	try {
	    ...
	    statusDAO.loadAllStatus();
	    List<TblStatusDTO> statusList = statusDAO.getListStatus();
