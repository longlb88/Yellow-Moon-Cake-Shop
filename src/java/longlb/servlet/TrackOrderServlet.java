...
public class TrackOrderServlet extends HttpServlet {
    private final Logger log = Logger.getLogger(TrackOrderServlet.class.getName());
    private final String TRACK_ORDER_PAGE = "track-order-page";
    /**
	...
	String orderID = request.getParameter("txtSearchOrder");
	String url = TRACK_ORDER_PAGE;
	String curUserID = "guest";
	...
	try {
	    ...
	    TblOrdersDTO ordersDTO = ordersDAO.getOrderByID(orderID, curUserID);
	    
	    if (ordersDTO != null){
		TblOrderDetailDAO orderDetailDAO = new TblOrderDetailDAO();
		orderDetailDAO.getDetailsByID(orderID);
		List<OrderItem> detailList = orderDetailDAO.getDetailList();
		
		request.setAttribute("ORDER", ordersDTO);
		request.setAttribute("ORDER_DETAILS", detailList);
	    }
