...
public class GoogleLoginUtils {
    private static final String GOOGLE_CLIENT_ID = "989512040444-79nhduv8ueh2kibgj634aodks60aqb3t.apps.googleusercontent.com";
    private static final String GOOGLE_CLIENT_SECRET = "Hvs58qP7isjXSa1hOS5jcJuf";
    private static final String GOOGLE_REDIRECT_URI = "http://localhost:8084/J3LP0011_YellowMoon/login-google";
