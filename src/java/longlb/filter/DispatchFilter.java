...
public class DispatchFilter implements Filter {
    ...
    private final Logger log = Logger.getLogger(DispatchFilter.class.getName());
	...
	try {
	    ...
	    String functionAlias = (String) request.getAttribute("FUNCTION_ALIAS");
	    
	    Map<String, String> functionsMap = (Map<String, String>) context.getAttribute("FUNCTIONS_MAP");
	    String url = functionsMap.get(functionAlias);
	    ...
	    log.error("Throwable t: " + t.getMessage());
	}
    }
